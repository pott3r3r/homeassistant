...
// Build HTML    
    return html`
      ...
      <ha-card class = "card">  
        <span class="icon bigger" id="icon-bigger" style="background: none, url(/local/icon/weather_icons/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this.current.conditions]}.svg) no-repeat; background-size: contain;">${this.current.conditions}</span>
            ...
            <div class="forecast clear">
              ${this.forecast.map(daily => html`
                <div class="day fcasttooltip">
                  ...
                  <br><i class="icon" id="fcast-icon-${daily.dayIndex}" style="background: none, url(/local/icon/weather_icons/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this._hass.states[daily.condition].state]}.svg) no-repeat; background-size: contain;"></i>
...
// Current Conditions
      ...
      root.getElementById("icon-bigger").style.backgroundImage = `none, url(/local/icon/weather_icons/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this.current.conditions]}.svg)`;
...
// Forecast blocks
      this.forecast.forEach((daily) => {
        ...
        root.getElementById("fcast-icon-" + daily.dayIndex).style.backgroundImage = `none, url(/local/icon/weather_icons/${this.config.static_icons ? "static" : "animated"}/${this.weatherIcons[this._hass.states[daily.condition].state]}.svg`;
